...
function DevMIFEA(msg) 
local hash = database:sismember(bot_id.."Dev:MIFEA:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMIFEA(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1804211204) then  
var = 'مطــور السـورس 𖦴'
elseif tonumber(user_id) == tonumber(1804211204) then
var = 'مطـورة السورس'
elseif tonumber(user_id) == tonumber(1804211204) then
var = 'المطور الاساسي'
elseif tonumber(user_id) == tonumber(SUDO) then
...
local UserName = (data.username_ or "MIFEA")
...
. MIFEA_Msg = 'ما يتطلع بيك' 
elseif msgs < 400 then 
MIFEA_Msg = 'شد حيلك' 
elseif msgs < 700 then 
MIFEA_Msg = 'بعد شد حيلك ولك' 
elseif msgs < 1200 then 
MIFEA_Msg = '😍رفع رأيت العباس' 
elseif msgs < 2000 then 
MIFEA_Msg ='متفاعل🤣 ولسركي' 
elseif msgs < 3500 then 
MIFEA_Msg = 'ولك شنو تفاعلك هذه بعد اريد🤣'  
elseif msgs < 4000 then 
MIFEA_Msg = ' نار وشرار' 
elseif msgs < 4500 then 
MIFEA_Msg = 'لك عاش'
elseif msgs < 5500 then 
MIFEA_Msg = 'شعندك مبين اكو بنات هلكد حاجي' 
elseif msgs < 7000 then 
MIFEA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
WaTaN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MIFEA_Msg = 'شنو بنات هواي حاجي هلكد'  
end
return MIFEA_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"MIFEA")  
...
if File_Name ~= "MIFEA.lua" then 
send(chat,msg.id_,"هذا الملف غير تابع لسورس")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
os.execute('rm -rf MIFEA.lua')
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
else
...
function plugin_MIFEA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MIFEA and msg then
pre_msg = plugin.MIFEA(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMIFEA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_, SourceMIFEA) 
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not DevMIFEA(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMIFEA(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,MIFEA_Msg) 
return false  
end 
if text then    
...
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MIFEAMifea01 ~= true then
end
...
if text == 'تعطيل التواصل ✯' and DevMIFEA(msg) then  
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MIFEAMifea01 ~= true then
end
...
if text == 'تفعيل البوت الخدمي ✯' and DevMIFEA(msg) then  
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MIFEAMifea01 ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @WaTaNTeaM')   
...
if text == 'تعطيل البوت الخدمي ✯' and DevMIFEA(msg) then  
local url,res = https.request('https://abbas.watanteam.tk/ch/joinch.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_WaTaNTeaM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @WaTaNTeaM')   
